<?php
/**
 * Plugin Name: Didit Verification
 * Description: didit verification
 * Plugin URI: https://codexpert.io
 * Author: Codexpert, Inc
 * Author URI: https://codexpert.io
 * Version: 0.9
 * Text Domain: didit-verification
 * Domain Path: /languages
 */

namespace Codexpert\DiditVerification;
...
final class Plugin {
	...
	private function define() {
		 ...
		 * @since 0.9
		 */
		define( 'Didit_Verification', __FILE__ );
		define( 'Didit_Verification_DIR', dirname( Didit_Verification ) );
		define( 'Didit_Verification_ASSET', plugins_url( 'assets', Didit_Verification ) );
		define( 'Didit_Verification_DEBUG', apply_filters( 'didit-verification_debug', true ) );
		 ...
		 * @var $plugin
		 */
		$this->plugin					= get_plugin_data( Didit_Verification );
		$this->plugin['basename']		= plugin_basename( Didit_Verification );
		$this->plugin['file']			= Didit_Verification;
		$this->plugin['server']			= apply_filters( 'didit-verification_server', 'https://codexpert.io/dashboard' );
		$this->plugin['min_php']		= '5.6';
		$this->plugin['min_wp']			= '4.0';
		$this->plugin['icon']			= Didit_Verification_ASSET . '/img/icon.png';
