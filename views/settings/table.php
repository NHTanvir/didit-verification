...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'didit-verification' ),
		'products'			=> __( 'Products', 'didit-verification' ),
		'order_total'		=> __( 'Order Total', 'didit-verification' ),
		'commission'		=> __( 'Commission', 'didit-verification' ),
		'payment_status'	=> __( 'Payment Status', 'didit-verification' ),
		'time'				=> __( 'Time', 'didit-verification' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'didit-verification' ),
		'draft'		=> __( 'Draft', 'didit-verification' ),
	],
];
