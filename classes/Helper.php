...
class Helper {
	 ...
	 *
	 * It'll look into /didit-verification directory of your active theme
	 * first. if not found, default template will be used.
	 * can be overwriten with didit-verification_template_overwrite_dir hook
	 *
	...
	public static function get_template( $slug, $base = 'views', $args = null ) {
		...
		$overwrite_template_dir = apply_filters( 'cd_template_overwrite_dir', get_stylesheet_directory() . '/didit-verification/', $slug, $base, $args );
		
		// default template directory
		$plugin_template_dir = dirname( Didit_Verification ) . "/{$base}/";
		...
		elseif ( file_exists( $plugin_template_path ) ) {
			...
			return __( 'Template not found!', 'didit-verification' );
		}
	}
}